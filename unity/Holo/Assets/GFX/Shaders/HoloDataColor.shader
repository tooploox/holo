    ...
    Properties
    {
        ...
        _TriplanarMappingBlendSharpness("Blend Sharpness", Range(1.0, 16.0)) = 4.0
            ...
            _EnvironmentColorZ("Environment Color Z (RGB)", Color) = (0.0, 0.0, 1.0, 1.0)
                ...
                _Color1("Color X (RGB)", Color) = (1.0, 0.0, 0.0, 1.0)
                _Color2("Color Y (RGB)", Color) = (0.0, 1.0, 0.0, 1.0)
                _Color3("Color Z (RGB)", Color) = (0.0, 0.0, 1.0, 1.0)
    }
        ...
        #define PROXIMITY_LIGHT_DATA_SIZE 6
                    ...
                    v2f vert(appdata_t v)
                    {
                        ...
                        // adding colro informaton from ModelInfo.json to shader color
                        // is later used to define albedo
                        o.color = fixed4(v.tangent.x/255, v.tangent.y/255, v.tangent.z/255, 1);
                    ...
                    fixed4 albedo = fixed4(1.0, 1.0, 1.0, 1.0);
                    albedo = fixed4((_Color1.rgb * i.color.x)+ (_Color2.rgb * i.color.y)+ (_Color3.rgb * i.color.z), 1.0);
                        ...
                        //if (i.color.r >= .1 || i.color.g >= .1 || i.color.b >= .1) albedo = ((_Color1.rgb * i.color.x) + (_Color2.rgb * i.color.y) + (_Color3.rgb * i.color.z), 1);
        #endif
