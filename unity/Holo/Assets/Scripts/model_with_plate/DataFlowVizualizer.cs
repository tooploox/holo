...
public class DataFlowVizualizer : MonoBehaviour
{
    ...
    private void CreateMesh()
    {
        ...
        // save Mesh to file
        AssetDatabase.DeleteAsset("Assets/test_points.mesh");
        AssetDatabase.CreateAsset(mesh, "Assets/test_points.mesh");

        GameObject go = new GameObject("Test Points Topology");
        ...
        AssetDatabase.DeleteAsset("Assets/test_points_game_object.prefab");
        PrefabUtility.SaveAsPrefabAsset(go, "Assets/test_points_game_object.prefab");
    }
