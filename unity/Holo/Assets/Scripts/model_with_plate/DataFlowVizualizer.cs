...
public class DataFlowVizualizer : MonoBehaviour
{
    ...
    private void CreateMesh()
    {
        ...
        // save Mesh to file
        AssetDatabase.DeleteAsset("Assets/test_quads.mesh");
        AssetDatabase.CreateAsset(mesh, "Assets/test_quads.mesh");
        ...
        AssetDatabase.DeleteAsset("Assets/test_quads_game_object.prefab");
        PrefabUtility.SaveAsPrefabAsset(go, "Assets/test_quads_game_object.prefab");
    }
